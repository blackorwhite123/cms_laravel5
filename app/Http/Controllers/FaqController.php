...
class FaqController extends Controller {
	...
	public function getIndex( Request $request )
	{
		...
		$sort = (!is_null($request->input('sort')) ? $request->input('sort') : 'faq_id'); 
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			$data = $this->getDataPost('faq');

			$type_pro =  !isset($data['faq_id']) ? "add" : "edit";
			...
			$id = $this->model->insertRow($data , \Input::get('faq_id'));
			...
			$id =  \Input::get('faq_id') ? \Input::get('faq_id') : "";
